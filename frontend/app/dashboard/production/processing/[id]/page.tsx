            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button size="sm" variant="outline"
                  onClick={() => router.push(`/dashboard/production/processing/${order.id}/jobs`)}>
                  View All Job Cards
                </Button>
                <Button size="sm"
            ...
            {order.job_cards.length > 0 ? (
              <div className="rounded-lg border p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  <Link href={`/dashboard/production/processing/${order.id}/jobs`} className="text-primary hover:underline">
                    View details &rarr;
                  </Link>
                </p>
              </div>
