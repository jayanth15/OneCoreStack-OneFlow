...
export const Route = createFileRoute("/_auth/dashboard/admin/users/new")({
...
function NewUserPage() {
  ...
  const allDepts = (deptsQuery.data as DeptRef[] | undefined) ?? []
  ...
  return (
    <>
      <PageHeader
        title="New User"
        description="Create a new system user and assign their departments."
        breadcrumbs={[
