...
## Corpus Check
- 322 files · ~302,852 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3244 nodes · 8259 edges · 249 communities (173 shown, 76 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 1768 edges (avg confidence: 0.63)
...
Cohesion: 0.05
Nodes (61): NewDepartmentPage(), DepartmentsPage(), UsersPage(), ApiRecord, BLANK_FORM(), BLANK_ITEM(), fetchInventoryItems(), INVENTORY_LABELS (+53 more)
...
Cohesion: 0.04
Nodes (76): BomDetail, EditBomPage(), InventoryItem, PaginatedInventory, DeptForm, BLANK, CompanyInfo, SettingsPage() (+68 more)

### Community 6 - "Linkable Purchase Requests"
Cohesion: 0.13
Nodes (49): GRNRecord, GRNItem, SQLModel, Line item within a GRN — one row per inventory item received., SQLModel, Goods Received Note — records a delivery of goods into the company., PurchaseOrder, PurchaseOrderItem (+41 more)
...
Cohesion: 0.08
Nodes (32): AlertDialogMedia(), AlertDialogOverlay(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage() (+24 more)
...
Cohesion: 0.25
Nodes (24): GatePass, GatePassItem, SQLModel, SQLModel, _add_gp_history(), _assign_purchase_order(), create_gate_pass(), delete_gate_pass() (+16 more)
...
Cohesion: 0.06
Nodes (66): _arm_timer(), _backup_dir_for(), cleanup_old_backups(), _db_path(), perform_backup(), datetime, Database backup scheduler.  Schedule:   - 17:30 (5:30 PM) every day: take a safe, Return the number of seconds until the next 17:30:00 (today or tomorrow). (+58 more)
...
Cohesion: 0.34
Nodes (18): cancel_po(), create_po(), get_po(), list_linkable_pos(), list_pos(), _next_po_number(), Any, Depends (+10 more)
...
Cohesion: 0.11
Nodes (14): get_linkable_pr_items(), get_linkable_pr_or_404(), Session, Helpers for 'linkable' Purchase Requests — used by GRN creation., Load a PR, raising 404 if it doesn't exist, is soft-deleted, or isn't linkable., Return line items for a linkable PR, shaped like `LinkablePROut`.      The PR it, add_security_headers(), global_exception_handler() (+6 more)
...
Cohesion: 0.06
Nodes (55): alembic_version_exists(), init_db(), Create all tables from SQLModel metadata. Called on startup.      For fresh data, Run Alembic migrations to bring the database to the latest revision., Stamp the database at the current Alembic head (for legacy catch-up)., Check if the alembic_version table exists (i.e., DB is already Alembic-managed)., run_alembic_upgrade(), stamp_alembic_head() (+47 more)
...
Cohesion: 0.11
Nodes (19): @base-ui/react, class-variance-authority, clsx, dependencies, @base-ui/react, class-variance-authority, clsx, @hugeicons/core-free-icons (+11 more)
...
Cohesion: 0.13
Nodes (14): DocumentCounter, SQLModel, Transactionally allocated sequence per document prefix., _create_grn_items(), _next_grn_number(), Session, Create GRNItem rows for a given GRN (used by create + update)., Derive GRN status from per-item fill/return totals. (+6 more)

### Community 66 - "Community 66"
Cohesion: 0.18
Nodes (14): admin_token(), create_admin(), create_dept(), prod_dept(), Department, User, qa_dept(), Pytest fixtures for OneFlow backend — in-memory SQLite, transaction-isolated per (+6 more)
...
Cohesion: 0.04
Nodes (60): BomPage(), EditDepartmentPage(), NewUserPage(), BLANK_FORM(), blankDispatchItem(), DispatchPage(), AttachmentsPage(), fmtDate() (+52 more)
...
Cohesion: 0.08
Nodes (30): CompanyInfo, receiptDirectionForUser(), receiptSignoffSummary(), ReceiptsPage(), STATUS_BADGES, STATUS_ICONS, DeptRef, errorMessage() (+22 more)
...
- **Why does `get_session()` connect `Database Session and Auth Core` to `Departments and Inventory History`, `Consumables Data Model`, `Auth and Inventory Module`, `Purchase Request Item Model`, `Combobox UI Component`, `Supplier Job Model`, `Legacy Migrations and Scheduling`, `Receipts and Requests Model`, `Purchase Request Routes`, `Community 30`, `Community 31`, `input-group.tsx`, `Community 37`, `Community 39`, `Community 42`, `Community 46`, `Community 49`, `Community 57`, `Community 60`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `User` connect `Departments and Inventory History` to `Spare Parts Data Model`, `Community 66`, `input-group.tsx`, `Consumables Data Model`, `Community 37`, `Database Session and Auth Core`, `Linkable Purchase Requests`, `BOM Edit Pages`, `Community 42`, `Auth and Inventory Module`, `Community 46`, `Weeder Category Model`, `Combobox UI Component`, `Community 49`, `Legacy Migrations and Scheduling`, `Request Items and Router`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `_seed_customers_from_schedules()` connect `Community 37` to `Community 56`, `Legacy Migrations and Scheduling`, `Community 46`, `Community 55`?**
