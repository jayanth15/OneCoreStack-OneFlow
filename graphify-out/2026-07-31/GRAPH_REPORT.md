# Graph Report - OneFlow  (2026-07-31)

## Corpus Check
- 308 files · ~252,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3108 nodes · 7818 edges · 242 communities (171 shown, 71 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 1614 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dcb6017e`
...
1. `cn()` - 151 edges
2. `User` - 143 edges
3. `get_session()` - 129 edges
4. `Unit` - 117 edges
5. `apiFetchJson()` - 99 edges
6. `InventoryItem` - 98 edges
7. `get_current_user()` - 79 edges
8. `Schedule` - 76 edges
...
## Communities (242 total, 71 thin omitted)

### Community 0 - "Admin Dashboard Pages"
Cohesion: 0.04
Nodes (77): BomItem, Department, DeptRef, ROLE_BADGE_VARIANT, ROLE_LABELS, User, AttachmentDocument, AttachmentItem (+69 more)

### Community 1 - "Spare Parts Data Model"
Cohesion: 0.07
Nodes (103): SQLModel, SpareCategory, SQLModel, Audit trail for every stock change on a SpareItem., SpareItemHistory, SQLModel, SpareItem, SQLModel (+95 more)

### Community 2 - "Departments and Inventory History"
Cohesion: 0.14
Nodes (41): JobCardHistory, SQLModel, Audit trail for every change on a JobCard.      One row per changed field per ed, JobCard, SQLModel, ProductionOrder, SQLModel, A production run linked to a Production Plan.      Production Orders group Job C (+33 more)

### Community 3 - "New BOM Creation UI"
Cohesion: 0.05
Nodes (51): InventoryItem, NewBomForm(), PaginatedInventory, RMRow, BLANK_FORM(), blankGPItem(), CompanyInfo, GatePass (+43 more)
...
Cohesion: 0.05
Nodes (75): BomDetail, InventoryItem, PaginatedInventory, DeptForm, BLANK, CompanyInfo, UnitItem, DeptRef (+67 more)
...
Cohesion: 0.10
Nodes (61): add_process(), bom_preview(), _calculated_hours_from_produced_qty(), _check_backward_status(), _consume_bom_materials(), create_job(), create_order(), create_plan() (+53 more)
...
Cohesion: 0.08
Nodes (53): AttachmentItem, AttachmentDocument, SQLModel, PDF/document attached to an Attachment inventory item., AttachmentHistory, SQLModel, Audit trail for every stock change on an Attachment item., AttachmentItem (+45 more)
...
Cohesion: 0.11
Nodes (45): One-time idempotent migration: copy unique customer_name values from existing, _seed_customers_from_schedules(), InventoryHistory, SQLModel, Audit trail for every stock change on an InventoryItem.      Written on: create,, InventoryItem, SQLModel, SQLModel (+37 more)

### Community 17 - "Units and Vendors Model"
Cohesion: 0.13
Nodes (36): PurchaseOrder, PurchaseOrderItem, SQLModel, cancel_po(), create_po(), get_po(), list_linkable_pos(), list_pos() (+28 more)
...
Cohesion: 0.23
Nodes (22): get_session(), Session, SQLModel, Audit trail for schedule status changes., ScheduleHistory, check_availability(), create_schedule(), delete_schedule() (+14 more)

### Community 20 - "Request Items and Router"
Cohesion: 0.12
Nodes (50): SQLModel, Line item for a Request.      Used for internal_transfer and vendor_purchase typ, RequestItem, create_notification(), Create a notification for a user. Called from other routers., accept_fulfilment(), accept_item(), _acceptance_departments() (+42 more)

### Community 21 - "Dashboard Layout and Auth Guard"
Cohesion: 0.06
Nodes (49): EditBomPage(), BomPage(), EditDepartmentPage(), NewDepartmentPage(), DepartmentsPage(), SettingsPage(), EditUserPage(), NewUserPage() (+41 more)
...
Cohesion: 0.18
Nodes (32): Dispatch, DispatchHistory, SQLModel, DispatchItem, SQLModel, SQLModel, create_dispatch(), _deduct_oem_dispatch_stock() (+24 more)
...
Cohesion: 0.10
Nodes (27): ApiRecord, BLANK_FORM(), BLANK_ITEM(), CompanyInfo, fetchInventoryItems(), INVENTORY_LABELS, INVENTORY_TYPES, InventoryItem (+19 more)
...
Cohesion: 0.05
Nodes (58): alembic_version_exists(), init_db(), Create all tables from SQLModel metadata. Called on startup.      For fresh data, Run Alembic migrations to bring the database to the latest revision., Stamp the database at the current Alembic head (for legacy catch-up)., Check if the alembic_version table exists (i.e., DB is already Alembic-managed)., run_alembic_upgrade(), stamp_alembic_head() (+50 more)
...
Cohesion: 0.11
Nodes (28): hash_password(), admin_token(), create_admin(), create_user_with_dept(), login(), User, A user in the requester's department can identify receipt source/target context., Delivery splits receipts by line-item department and closes only after all are s (+20 more)
...
Cohesion: 0.06
Nodes (42): CycleCountPage(), CycleRow, fmtLocation(), fmtQty(), InventoryListItem, loadCycleRows(), Paginated, SECTION_LABEL (+34 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (45): _arm_timer(), _backup_dir_for(), cleanup_old_backups(), _db_path(), perform_backup(), datetime, Database backup scheduler.  Schedule:   - 17:30 (5:30 PM) every day: take a safe, Return the number of seconds until the next 17:30:00 (today or tomorrow). (+37 more)

### Community 43 - "Community 43"
Cohesion: 0.24
Nodes (16): SQLModel, Unified request: internal transfer | vendor purchase | customer dispatch.      R, Request, _customer_request(), _headers(), _internal_request(), InventoryItem, WeederItem (+8 more)
...
Cohesion: 0.11
Nodes (22): CompanyInfo, receiptDirectionForUser(), receiptSignoffSummary(), ReceiptsPage(), STATUS_BADGES, STATUS_ICONS, errorMessage(), formatDateTime() (+14 more)

### Community 51 - "Community 51"
Cohesion: 0.12
Nodes (15): AvailableRequest, BLANK_FORM(), blankDispatchItem(), CompanyInfo, Dispatch, DISPATCH_INV_TYPES, DispatchAPIItem, DispatchFormState (+7 more)
...
Cohesion: 0.22
Nodes (17): SQLModel, Configurable work-type categories for time tracking.      Managed by admins; ref, WorkType, create_work_type(), delete_work_type(), list_work_types(), BaseModel, Depends (+9 more)
...
Cohesion: 0.25
Nodes (21): SQLModel, User, _build_response(), create_user(), delete_user(), DeptRef, get_user(), _get_user_departments() (+13 more)
...
Cohesion: 0.11
Nodes (8): EmptyState(), EmptyStateProps, PageShell(), PageShellProps, SheetDescription(), SheetFooter(), SheetOverlay(), TooltipContent()

### Community 66 - "Community 66"
Cohesion: 0.20
Nodes (13): create_dept(), prod_dept(), Department, qa_dept(), Pytest fixtures for OneFlow backend — in-memory SQLite, transaction-isolated per, Per-test session with a transaction that is rolled back after each test., session(), Admin quantity adjustment during request approval. (+5 more)
...
### Community 221 - "_migrate_grn_v2"
Cohesion: 0.40
Nodes (5): Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger()

### Community 222 - "_migrate_job_card_worker_id"
Cohesion: 0.67
...
- **Why does `get_session()` connect `Legacy Migrations and Scheduling` to `Departments and Inventory History`, `Consumables Data Model`, `Database Session and Auth Core`, `Auth and Inventory Module`, `Combobox UI Component`, `Units and Vendors Model`, `Supplier Job Model`, `Receipts and Requests Model`, `Purchase Request Routes`, `Community 33`, `Community 34`, `Community 39`, `Community 40`, `Community 42`, `Community 46`, `Community 49`, `Community 53`, `Community 60`, `get_linkable_pr_items`, `Community 112`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `User` connect `Community 60` to `Spare Parts Data Model`, `Departments and Inventory History`, `Consumables Data Model`, `Linkable Purchase Requests`, `Database Session and Auth Core`, `BOM Edit Pages`, `Auth and Inventory Module`, `Weeder Category Model`, `Combobox UI Component`, `Legacy Migrations and Scheduling`, `Request Items and Router`, `Community 33`, `Community 34`, `Community 42`, `Community 43`, `Community 46`, `Community 49`, `Community 53`, `get_linkable_pr_items`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `_seed_customers_from_schedules()` connect `Combobox UI Component` to `Community 56`, `Community 33`, `Community 55`?**
