...
class PurchaseRequestHistory(SQLModel, table=True):
    """Audit trail for purchase request changes."""
    __tablename__ = "purchase_request_history"

    id: Optional[int] = Field(default=None, primary_key=True)

    request_id: int = Field(foreign_key="purchase_request.id", index=True)
