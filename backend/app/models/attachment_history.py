...
class AttachmentHistory(SQLModel, table=True):
    """Audit trail for every stock change on an Attachment item."""
    __tablename__ = "attachment_history"

    id: Optional[int] = Field(default=None, primary_key=True)
    attachment_id: int = Field(foreign_key="attachment_item.id", index=True)
