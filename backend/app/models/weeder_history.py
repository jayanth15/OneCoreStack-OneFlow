...
class WeederHistory(SQLModel, table=True):
    """Audit trail for every stock change on a Weeder item."""
    __tablename__ = "weeder_history"

    id: Optional[int] = Field(default=None, primary_key=True)
    weeder_id: int = Field(foreign_key="weeder_item.id", index=True)
